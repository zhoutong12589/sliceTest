    ...
    _createClass(ConnectionI, [{
        ...
        value: function checkClose() {
            ...
            if (this._asyncRequests.size === 0 && this._closePromises.length > 0) {
                this.setState(StateClosing, new Ice.ConnectionManuallyClosedException(true));
                this._closePromises.forEach(function (p) {
                    return p.resolve();
                });
                this._closePromises = [];
            }
        ...
        key: "waitUntilHolding",
        value: function waitUntilHolding() {
                ...
                if (callback !== null) {
                    Timer.setImmediate(function () {
                        try {
                            ...
                            _this2._logger.error("connection callback exception:\n" + ex + '\n' + _this2._desc);
                        }
                    });
                }
            } else {
        ...
        value: function message(operation) {
            ...
            if (this._hasMoreData.value) {
                Timer.setImmediate(function () {
                    _this3.message(SocketOperation.Read);
        ...
        key: "scheduleTimeout",
        value: function scheduleTimeout(op, timeout) {
            var _this4 = this;
        ...
        value: function checkState() {
            ...
            this._holdPromises.forEach(function (p) {
                return p.resolve();
            });
            this._holdPromises = [];
