...
var RetryException = function (_extendableBuiltin2) {
    _inherits(RetryException, _extendableBuiltin2);

    function RetryException(ex) {
        _classCallCheck(this, RetryException);

        var _this = _possibleConstructorReturn(this, (RetryException.__proto__ || Object.getPrototypeOf(RetryException)).call(this));
